  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 sm:py-12">
        <div className="mb-8">
          <Badge className="bg-green-100 text-green-800 hover:bg-green-100 mb-4 text-sm px-2 py-0.5">
            Assessment Complete
          </Badge>
        ...
        <Card className="p-6 sm:p-8 mb-6">
          ...
          <div className="bg-muted rounded-lg p-6 mb-6">
            <h3 className="text-base font-semibold mb-3">Factors Supporting Eligibility:</h3>
