      ...
      <main className="max-w-4xl mx-auto px-4 py-8 sm:py-12">
        ...
        <Card className="p-6 sm:p-8 mb-6">
          ...
          <div className="bg-muted rounded-lg p-6 mb-6">
            <h3 className="font-semibold mb-3">Why this determination was made:</h3>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <div className="bg-white rounded-lg p-4 border border-purple-200">
                ...
                <p className="text-lg font-bold text-foreground mb-1">1-800-403-0864</p>
                <p className="text-xs text-muted-foreground">Monday-Friday, 8am-5pm EST</p>
                <p className="text-xs text-muted-foreground mt-2">TTY: 1-800-743-3333</p>
              </div>
            </div>
          </div>
        </Card>
