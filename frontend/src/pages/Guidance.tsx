        ...
        <Card className="p-6 sm:p-8 mb-6 bg-blue-50 border-blue-200">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h2 className="text-xl font-semibold mb-2">Your Assessment Summary</h2>
            ...
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1">
                ...
                <div className="bg-muted rounded-lg p-4">
                  <p className="text-sm font-semibold mb-2">Important Contact Information:</p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="bg-white rounded-lg p-4 border border-amber-300">
                  <p className="text-sm font-semibold mb-2">Assessment Summary for Provider:</p>
